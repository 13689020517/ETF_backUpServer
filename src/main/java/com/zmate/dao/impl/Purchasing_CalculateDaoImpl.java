...
import com.zmate.dao.Purchasing_CalculateDao;
...
@Component
public class Purchasing_CalculateDaoImpl implements Purchasing_CalculateDao {
    MongoCollection<Document> collection;

    public Purchasing_CalculateDaoImpl() {
        collection = MainApp.database.getCollection("purchasing_Calculate");
    }
