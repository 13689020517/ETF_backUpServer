...
import com.zmate.dao.Purchasing_Order_Dao;
...
@Component
public class Purchasing_Order_DaoImpl implements Purchasing_Order_Dao {

    MongoCollection<Document> collection;
    MongoCollection<DBObject> collection1;

    public Purchasing_Order_DaoImpl() {
