...
public class exchangeTreatCenter_PurchasingChart_Bean {
    ...
    public String toString() {
        return "exchangeTreatCenter_PurchasingChart_Bean{" +
                "tx_Hash='" + tx_Hash + '\'' +
                ", client_ID='" + client_ID + '\'' +
    ...
    public exchangeTreatCenter_PurchasingChart_Bean(String tx_Hash, String client_ID, String purchasing_Value, String fund_Recieved_Value, String evaluate_Purchasing_Value, String today_Net_Price, String evaluate_Quotient, String gas1, String fee_Rate, String fee, String other_Fee, String submit_Time) {
        this.tx_Hash = tx_Hash;
        this.client_ID = client_ID;
        this.purchasing_Value = purchasing_Value;
        this.fund_Recieved_Value = fund_Recieved_Value;
